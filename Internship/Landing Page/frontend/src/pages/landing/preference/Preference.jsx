      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="bg-[#F8FBFD]">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-cyan-500">
              3k+
            </h1>

            <p className="text-xl sm:text-2xl mt-8 font-medium text-slate-800">
          ...
          <Card className="bg-[#F8FBFD]">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 mt-8 sm:mt-12">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-cyan-500 rounded-2xl flex items-center justify-center">
          ...
          <Card className="bg-[#F8FBFD]">
            ...
            <div className="text-gray-500 mt-5 leading-8 text-sm sm:text-base">
          ...
          <Card className="bg-[#F8FBFD]">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mt-2">$1,876,580</h2>

            <div className="mt-8 h-40 sm:h-52 bg-white rounded-xl border p-5">
